...
const HomeClient = ({ email }: { email?: string }) => {
    ...
    const features = [
        {
            title :"Plug & Play",
            desc :"Add the Chatbox to your site with s single script tag. "
        },
        {
    ...
    return (
        <div className='min-h-screen bg-linear-to-br from-white to bg-zinc-50 text-zinc-900 overflow-x-hidden '>
            <motion.div
                ...
                <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
                    ...
                    >
                        ...
                        <div className='mt-10 flex gap-4'>
                            ...
                            bg-black text-white font-medium hover:bg-zinc-800 transition
                            disabled:opacity-60'>
                                Go To Dashboard
                            </button> :
                        ...
                        <div className='rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6'>
                            ...
                            <div className='space-y-3'>
                                <div className='bg-black text-white rounded-lg px-4 py-2 text-sm ml-auto w-fit'>
                                    Do you offer Cash On delievery?
                                </div>
                                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit'>
                                    Yes,Cash on Delievery is available
                                </div>
                            </div>
                            <motion.div
                            animate={{y: [0, -12, 0]}}
